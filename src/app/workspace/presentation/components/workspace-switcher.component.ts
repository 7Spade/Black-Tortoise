...
import { WorkspaceCreateResult, WorkspaceFacade } from '@workspace/application';
        ...
        @if (facade.showWorkspaceMenu()) {
          ...
          <div class="workspace-menu">
            @for (
              ...
              track workspace.id.getValue()
            ) {
              <button
                class="workspace-menu-item"
                [class.active]="facade.isWorkspaceActive(workspace.id.getValue())"
                (click)="facade.selectWorkspace(workspace.id.getValue())"
                type="button"
              >
