 ...
 * Purpose: Manages global presentation state using NgRx Signals
 * Architecture: Zone-less, Pure Reactive, Angular 20+
 *
 * Responsibilities:
 * - Global UI state (notifications, search, theme, etc.)
 * - Presentation-specific signals and computed values
 * - No business logic - pure UI state management
 * - Coordinates with application layer for data
 */
