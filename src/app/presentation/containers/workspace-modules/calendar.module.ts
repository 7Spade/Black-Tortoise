...
export class CalendarModule implements Module, OnInit, OnDestroy {
  ...
  initialize(eventBus: WorkspaceEventBus): void {
    ...
    this.subscriptions.add(
      ModuleEventHelper.onWorkspaceSwitched(eventBus, (event) => {
        console.log(`[CalendarModule] Workspace switched:`, event);
      })
    );
  ...
  activate(): void {
    console.log(`[CalendarModule] Activated`);
  }
  
  deactivate(): void {
    console.log(`[CalendarModule] Deactivated`);
  }
  
  destroy(): void {
    this.subscriptions.unsubscribeAll();
    console.log(`[CalendarModule] Destroyed`);
  }
