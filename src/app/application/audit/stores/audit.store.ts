...
import { EVENT_BUS } from '@application/interfaces'; // Check path alias
...
import { AuditLogView } from '../models/audit-log-view.model';

export interface AuditState {
    readonly entries: ReadonlyArray<AuditLogView>;
    readonly filter: {
...
export const AuditStore = signalStore(
    ...
    withMethods((store) => {
        ...
        return {
             ...
             * Add audit entry
             */
            addEntry(entry: Omit<AuditLogView, 'id'>): void {
                const newEntry: AuditLogView = {
                    ...entry,
                    id: crypto.randomUUID(),
                };
             ...
             */
            addEntries(entries: Array<Omit<AuditLogView, 'id'>>): void {
                const newEntries: AuditLogView[] = entries.map((e) => ({
                    ...e,
                    id: crypto.randomUUID(),
                }));
