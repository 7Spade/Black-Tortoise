...
## 1. CRITICAL: Dependency Direction
...
## 3. Naming Conventions (ALL MANDATORY - File rejected on violation)
...
## 5. Import Patterns (MANDATORY - Use path aliases ONLY)
...
## 7. Example Import (Correct)

```ts
import { Workspace } from '@domain/entities/workspace.entity';
import { WorkspaceStore } from '@application/workspace.store';
import { WorkspaceFirestoreRepository } from '@infrastructure/workspace-firestore.repository';
import { WorkspaceListComponent } from '@presentation/workspace-list.component';
import { formatDate } from '@shared/utils/date';
````

## 8. Example Store Patch (NgRx Signals)
...
// ❌ Direct infrastructure access in application
import { WorkspaceFirestoreRepository } from '@infrastructure/workspace-firestore.repository';
